...
class mfnet_detector(object):
    ...
    def _createLoss(self):
        ...
        obj_mat = mask_obj ## (None, 13, 13, bboxNum * bboxNum)
...
#         # print self._objMask_dup.get_shape()
        ...
        conf_pred = tf.nn.sigmoid(self._output[..., 4 * self._bboxNum: 5 * self._bboxNum]) ### (None, 13, 13, bboxNum)
...
#         ######################################################################################
    ...
    def fit(self, batchDict):
        ...
        opt, lossResult, box_loss, conf_obj_loss, conf_noobj_loss, class_loss, classAcc, objAcc, noobjAcc, objNum \
            = self._sess.run(
